...
public class FrameStreamer extends FrameReceiver implements AudioListener {
    private final FFmpegFrameRecorder recorder;
    private long startTime = 0;
    private int frameCount = 0;
    private long lastFrameTime;

    public FrameStreamer(String url, int width, int height) {
        this.recorder = new FFmpegFrameRecorder(url, width, height, 2);
...
//        recorder.setVideoOption("profile", "base");
